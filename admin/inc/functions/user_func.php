    ...
    if (!$errors) {
        ...
        if ($result === true) {
                ...
                <body>
                        ...
                        <img src='https://royalunionpro.com/media/white-logo.png' width='150' class='rounded' alt='dd'> <br>
                
                            <h2 style='color: #fff !important'>Hello,</h2>
                            <h3 style='color: #fff !important'>Welcome to Royal Union. The bank that serves all customers equally on a daily basis</h3> 
                            ...
                            <p style='color: #fff !important'><i>Thank you for choosing Royal Union</i></p>
                        </div>
                ...
                ";
                sendEmail($email, "Welcome to Royal Union", $message);
            return true;
        } else {
        ...
        if ($result) {
            ...
            $otp = generateNumber(4);
                ...
                <body>
                    ...
                    <img src='https://royalunionpro.com/media/white-logo.png' width='150' style='border-radius: 0.25rem!important' alt='Royal Union'> <br>
            ...
            $message = "
                ...
                <body>
                        ...
                        <div style='background: #452121; padding: 1rem; color: #fff !important; border-radius: 0.25rem!important; width: 500px; text-align: center!important; box-shadow: 0 .5rem 1rem rgba(0,0,0,.15)!important; font-family: sans-serif;'>
                            ...
                            <p class='text-center mt-2'><i>Royal Union</i></p>
                        </div>
                
                </body>
                </html>
                ";
                sendEmail($email, "Royal Union Login Notification", $message);
            return true;
        } else {
            ...
            if ($amount <= $total_balance) {
                ...
                <body>
                        <div style='background: #452121; padding: 1rem; color: #fff !important; border-radius: 0.25rem!important; width: 500px; text-align: center!important; box-shadow: 0 .5rem 1rem rgba(0,0,0,.15)!important; font-family: sans-serif;'>
                            ...
                            <p style='color: #fff !important'><i>Royal Union</i></p>
                        </div>
                ...
                ";
                sendEmail($email, "Royal Union Alert", $message);
                sendEmail($receiver_email, "Royal Union Alert", $rec_message);
                    return true;
                }
            } else {
                $message = "
                ...
                ";
                sendEmail($email, "Royal Union Notification", $message);
