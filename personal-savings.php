  ...
  <section class="pt-140 pb-100 get-touch-area bg_white">
    <div class="container">
      ...
      <section class="bank-app-showcase-area bg-white">
        <div class="container">
          <h3 style="margin-bottom: 50px; font-weight: bold;">Earn, Grow, Save!</h3>
          <div class="row align-items-center flex-row-reverse">
              ...
              <div class="app-content">
                <div class="section-title bank-section-title text-start">
                  <p class="wow fadeInUp" data-wow-delay="0.9s"
                    ...
                    You've earned it. Now watch it grow! These FDIC insured(Opens in a new Window) accounts pay
                    competitive yields on your savings. Your money will be available should you need it, and until then,
                    your funds will be growing and working here in our community.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-5">
              <img class="wow fadeInUp mb-4" data-wow-delay="0.4s" src="https://www.horizontrustco.com/media/box-3.png"
                alt="" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
            </div>
            ...
            <ul class="list-unstyled feature-list wow fadeInUp" data-wow-delay="0.4s"
              ...
              <li> <i class="fas fa-check-circle"></i> Click for our current interest rate or Annual Percentage
                Yield(APY). </li>
              <li> <i class="fas fa-check-circle"></i>Minimum balance required is only $10.</li>
              <li> <i class="fas fa-check-circle"></i>$3 quarterly maintenance fee if balance falls below $10</li>
              <li> <i class="fas fa-check-circle"></i>You may make up to 6 withdrawals per quarter at no charge</li>
              <li> <i class="fas fa-check-circle"></i>There is a $1 fee per withdrawal in excess of 6 per quarter</li>
              <li> <i class="fas fa-check-circle"></i>Interest paid quarterly on your quarterly account statement</li>
              <li> <i class="fas fa-check-circle"></i>Minimum opening deposit of $10 required</li>
            </ul>
            <h3 style="margin-bottom: 5%; margin-top: 5%; font-weight: bold;">Working Money Account</h3>
            <p class="wow fadeInUp" data-wow-delay="0.9s"
              ...
              tiers and their corresponding Interest Rate / Annual Percentage Yield.</p>
            ...
            <ul class="list-unstyled feature-list wow fadeInUp" data-wow-delay="0.4s"
              ...
              <li> <i class="fas fa-check-circle"></i>No monthly maintenance fee</li>
              <li> <i class="fas fa-check-circle"></i>Interest will be credited each month on the last day of the
                monthly statement cycle.</li>
              <li> <i class="fas fa-check-circle"></i>You may make up to 6 transfers from this account per month.</li>
