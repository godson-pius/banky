    ...
    <main>
        ...
        <section class="pt-140 pb-100 get-touch-area bg_white">
            <div class="container">
                ...
                <p class="wow fadeInUp" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">You First! Select the checking plan that fits your life. Each of these accounts include: Free E-Statements, Free Online Banking(Opens in a new Window), First Anywhere app and more! Ask us about Online Bill Pay(Opens in a new Window)#. Please come in to one of our branches(Opens in a new Window) to open your account. When you open your account you receive your FREE Debit Mastercard issued instantly with your choice of over 110 Card Designs(PDF 16 MB) .
                    Below is a chart summarizing our accounts. For more details click on "Learn More" in the far right column.</p>

                <table class="table table-border table-time mt-5 wow fadeInUp" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                    <thead>
                        <tr>
                            <th>Account type</th>
                            <th>Openning deposit</th>
                ...
                <p class="mt-5 wow fadeInUp" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">Your first 25 Online Bill Payments per statement cycle will be processed at NO CHARGE. Any Bill Payments in excess of the first 25 (per statement cycle) will cost 50 cents each.
                ...
                <h3 class="mt-5 wow fadeInUp" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">Disclosure For All Interest Bearing Deposit Accounts</h3>
                <p class="wow fadeInUp" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">The following applies to all interest bearing accounts listed on this schedule of fees and services. The interest rate and Annual Percentage Yield (APY) are subject to change weekly.</p>
                ...
                <ul class="list-unstyled feature-list wow fadeInUp mt-3" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
                    ...
                    <li class="mt-2"> <i class="fas fa-check-circle"></i> Accrual: Interest begins to accrue no later than the day we receive full credit for the deposit of non-cash items (for example checks).</li>
