                        ...
                        <div class="row row-fit-lg">
                            ...
                            <div>
                                ...
                                <div class="title wow fadeInUp" data-wow-delay="0.9s"
                                    ...
                                    <p>First Take: The Least Boring Banking Podcast (Episode 12 - IRS Reporting
                                ...
                                <p class="title wow fadeInUp" data-wow-delay="0.9s"
                                    ...
                                    would need to make it out of committee, through Congress, and to the President's
                                    desk before becoming law.
                                    Oftentimes, these packages come out of committee unrecognizable if they even make it
                                    out at all.
                                </p><br>
                                <p class="title wow fadeInUp" data-wow-delay="0.9s"
                                    style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp; display: block; margin-block-start: 1em; margin-block-end: 1em; margin-inline-start: 0px; margin-inline-end: 0px; font-family: 'Roboto', sans-serif; font-weight: 400; font-size: 16px; line-height: 40px; margin-top: 30px;">
                                    ...
                                    the note sent to Speaker of the House Nancy Pelosi, Chairman Richard Neal of the
                                    Ways and Means Committee,
                                    Commissioner Charles Rettig of the IRS, and Treasury Secretary Janet Yellen,
                                    lawmakers who signed the letter stated, "We are concerned about a recent IRS data
                                    collection proposal to increase tax information reporting requirements on financial
                                    institutions, which we do not believe are necessary or helpful toward closing the
                                    'Tax Gap'."
                                    You can read the full letter and see those who signed by clicking here(Opens in a
                                    new Window).
                                </p><br>
                                <p class="title wow fadeInUp" data-wow-delay="0.9s"
                                    style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp; display: block; margin-block-start: 1em; margin-block-end: 1em; margin-inline-start: 0px; margin-inline-end: 0px; font-family: 'Roboto', sans-serif; font-weight: 400; font-size: 16px; line-height: 40px; margin-top: 30px;">
                                    ...
                                    banks to report on every single customer financial account with grows inflows and
                                    outflows above $600 – creating a mountain of new data – will lead to better tax
                                    compliance,"
                                    the association said to Politifact reporter Tom Kertscher. (Politifact article by
                                    Tom Kertscher)
                                </p><br>
                                <p class="title wow fadeInUp" data-wow-delay="0.9s"
                                    style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp; display: block; margin-block-start: 1em; margin-block-end: 1em; margin-inline-start: 0px; margin-inline-end: 0px; font-family: 'Roboto', sans-serif; font-weight: 400; font-size: 16px; line-height: 40px;  margin-top: 30px;">
